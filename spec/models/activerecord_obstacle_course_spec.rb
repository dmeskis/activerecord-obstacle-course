...
describe 'ActiveRecord Obstacle Course' do
  ...
  it 'finds order id of largest order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    order_id = Order.limit(1).order(amount: :desc).first.id
    # ------------------------------------------------------------
  ...
  it 'finds multiple items by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    items = Item.where("id = 1 OR id = 2 OR id = 4")
    # ------------------------------------------------------------
  ...
  it 'finds multiple orders by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders = Order.where("id = 1 OR id = 3 OR id = 5 OR id = 7")
    # ------------------------------------------------------------
  ...
  it 'returns the name of items associated with a specific order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    names = Order.last.items.pluck("items.name")
    # ------------------------------------------------------------
  ...
  it 'returns all orders for user 2 which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    orders = Order.where(user_id: 2).joins(:order_items).where("order_items.item_id = ?", 4)
    # -----------------------------------------------------------
  ...
  it 'returns items that are associated with one or more orders' do
    ...
    ordered_items = Item.joins(:order_items).group('items.id').having('count(item_id) > 1')
    # ---------------------------------------------------------------
  ...
  it 'returns the names of items that are associated with one or more orders' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    ordered_items_names = Item.joins(:order_items).group('items.id').having('count(item_id) >1').pluck(:name)
    # ---------------------------------------------------------------
  ...
  it 'returns a table of information for all users orders' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    custom_results = User.joins(:orders).select('users.name, count(orders.id) as total_order_count').group('users.name')
    # ---------------------------------------------------------------
  ...
  it 'returns a table of information for all users items' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
 custom_results = User.joins(:order_items).select('users.name, count(order_items.id) as total_item_count').
                  group('users.name').
  ...
  it 'returns a table of information for all users orders and item counts' do
    ...
    data = User.joins(:order_items).
                select('users.name as user_name, order_items.order_id, count(order_items.item_id) as item_count').
                group('users.name, order_items.order_id').order('users.name desc')
    # ---------------------------------------------------------------
